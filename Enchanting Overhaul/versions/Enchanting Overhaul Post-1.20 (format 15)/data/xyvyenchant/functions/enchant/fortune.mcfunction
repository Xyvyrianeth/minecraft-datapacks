...
execute if predicate xyvyenchant:enchantment/fortune/1 run xp add @s -2 levels
execute if predicate xyvyenchant:enchantment/fortune/2 run xp add @s -5 levels
execute if predicate xyvyenchant:enchantment/fortune/3 run xp add @s -9 levels