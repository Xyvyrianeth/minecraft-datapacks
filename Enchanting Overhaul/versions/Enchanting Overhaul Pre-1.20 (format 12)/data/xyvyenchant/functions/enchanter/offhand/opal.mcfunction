...
## INFINITY
execute as @a at @s if predicate xyvyenchant:mainhand/bow unless predicate xyvyenchant:enchantment/infinity/0 run title @s actionbar "§6Infinity §f| §cIncompatible §fwith §eMending"
...
## MULTISHOT
execute as @a at @s if predicate xyvyenchant:mainhand/crossbow unless predicate xyvyenchant:enchantment/piercing/0 run title @s actionbar "§6Multishot §f| §cIncompatible §fwith §ePiercing"
...
execute as @a at @s if predicate xyvyenchant:mainhand/armor unless predicate xyvyenchant:enchantment/protection/0 run title @s actionbar "§6Projectile Protection §f| §cIncompatible §fwith §eProtection"
execute as @a at @s if predicate xyvyenchant:mainhand/armor unless predicate xyvyenchant:enchantment/fire_protection/0 run title @s actionbar "§6Projectile Protection §f| §cIncompatible §fwith §eFire Protection"
execute as @a at @s if predicate xyvyenchant:mainhand/armor unless predicate xyvyenchant:enchantment/blast_protection/0 run title @s actionbar "§6Projectile Protection §f| §cIncompatible §fwith §eBlast Protection"
